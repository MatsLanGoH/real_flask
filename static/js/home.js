...
ns.model = (function() {
  ...
  return {
    ...
    update: function(first_name, last_name) {
      let ajax_options = {
        type: "PUT",
        url: "api/people/" + last_name,
        accepts: "application/json",
        contentType: "application/json",
        dataType: "json",
        data: JSON.stringify({
    ...
    build_table: function(people) {
      ...
      if (people) {
        for (let i = 0, l = people.length; i < l; i++) {
          rows += `<tr><td class="first_name">${people[i].first_name}</td><td class="last_name">${people[i].last_name}</td><td>${people[i].timestamp}</td></tr>`;
        }
